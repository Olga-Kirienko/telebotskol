...
MESSAGES = {
    ...
    "pronunciation_correct": "Вы верно произнесли слово! 👍",
    "pronunciation_incorrect": "Я не смог различить, попробуйте ещё раз 🤔",
    ...
    "listening_correct": "Вы верно произнесли фразу! 👍",
    "listening_incorrect": "Я не смог различить, попробуйте ещё раз 🤔",
    "true_answer": "Верно",
    ...
    "speaking_final": "Мозг, конечно, подпотел... но ты прошёл это! Даже английский немного в шоке. Переходим к следующему уроку?",
